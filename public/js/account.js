...
function changePassActive() {
  if ($('.changePass').is(':checked')) {
    ...
    $("[name='user-account__oldPassword'], [name='user-account__newPassword'], [name='user-account__passwordConfirm']").prop('required', true);
    $("#showChangePass:checked ~ .form-control").css('display','flex !important')
  } else {
    $('#showChangePass').removeAttr('checked')
    $("[name='user-account__oldPassword'], [name='user-account__newPassword'], [name='user-account__passwordConfirm']").prop('required', false);
